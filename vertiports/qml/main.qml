...
Window {
        ...
        Rectangle {
            ...
            Button {
                ...
                onClicked: {
                    ...
                    } else if (!ledController.isValidIp(ipAddress)) {  // Исправил имя метода на isValidIp
            ...
            Button {
                ...
                onClicked: {
                    ledController.startScan();  // Исправил имя метода на startScan
                }
            }
            ...
            Rectangle {
                ...
                Connections {
                    ...
                    function onConnectionStatusChanged(newStatus) {  // Используем новый синтаксис для Connections
                ...
                Rectangle {
                    ...
                    Button {
                        ...
                        onClicked: {
                            ...
                            ledController.changeVertiport(index, status, r, g, b);  // Исправил имя метода на changeVertiport
                        }
                    }
                }
            }
    ...
    Dialog {
        ...
        MouseArea {
            ...
            onPositionChanged: {
                if (mouse.buttons & Qt.LeftButton) updateColor(mouseX, mouseY)
                console.log("Mouse X: " + mouseX + ", Mouse Y: " + mouseY)  // Исправил опечатку в console.log
            }
        }
